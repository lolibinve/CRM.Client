...
{
    /// <summary>
    /// RectangleAnimationBackground.xaml 的交互逻辑
    /// </summary>
    public partial class RectangleAnimationBackground : UserControl
    {
        /// <summary>
        /// 随机数
        /// </summary>
        ...
        /// 点信息阵距
        /// </summary>
        private PointInfo[,] _points = null;
        ...
        public RectangleAnimationBackground()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty RowCountProperty =
            DependencyProperty.Register(nameof(RowCount), typeof(int), typeof(RectangleAnimationBackground), new PropertyMetadata(8));
        public static void OnRowCountPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is RectangleAnimationBackground control)
            {
                control.Initialize();
            }
        }
        ...
        public static readonly DependencyProperty ColumnCountProperty =
            DependencyProperty.Register(nameof(ColumnCount), typeof(int), typeof(RectangleAnimationBackground), new PropertyMetadata(8));
        public static void OnColumnCountPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is RectangleAnimationBackground control)
            {
                control.Initialize();
        ...
        {
            _timer?.Stop();
            _points = new PointInfo[ColumnCount, RowCount];
